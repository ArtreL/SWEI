...
namespace MyUnitTests
{
    ...
    {
        public Stream GetValidRequestStream(string url, string method = "GET", string host = "localhost", string[][] header = null, string body = null)
        {
            byte[] bodyBytes = null;
            if (body != null)
            {
        ...
        public Stream GetInvalidRequestStream()
        {
            var ms = new MemoryStream();
            var sw = new StreamWriter(ms, Encoding.ASCII);
        ...
        public Stream GetEmptyRequestStream()
        {
            var ms = new MemoryStream();
            var sw = new StreamWriter(ms, Encoding.ASCII);
